...
'''
1. By default sel.css()[0], otherwise specify '__unique':False or  __list:True
2. by default, css parsing ，otherwise specify '__use':'dump' to indicate it is a dumping data
'''
